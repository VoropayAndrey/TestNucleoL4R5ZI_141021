...
#include "main.h"
#include "stm32l4xx.h"           /* STM32F register definitions.              */
#include "stm32l4xx_hal_gpio.h"      /* STM32F GPIO control functions.            */
#include "stm32l4xx_hal_uart.h"     /* STM32F USART control functions.           */
#include "stm32l4xx_hal_rcc.h"       /* STM32F Clock control functions.           */
#include "stm32l4xx_hal_dma.h"       /* STM32F DMA control functions.             */
#include "stm32l4xx_hal_exti.h"      /* STM32F Ext interrupt definitions.         */
...
#define HCITR_DMA_RXD_CHANNEL    6
...
#define HCITR_UART_IRQ_HANDLER         (DEF_CONCAT3(HCITR_UART_TYPE, HCITR_UART, _IRQHandler)) // USART3_IRQHandler
...
#define HCITR_TXD_GPIO_AHB_BIT         (DEF_CONCAT3(RCC_AHB2ENR_GPIO, HCITR_TXD_PORT, EN))
#define HCITR_RXD_GPIO_AHB_BIT         (DEF_CONCAT3(RCC_AHB2ENR_GPIO, HCITR_RXD_PORT, EN))
#define HCITR_RTS_GPIO_AHB_BIT         (DEF_CONCAT3(RCC_AHB2ENR_GPIO, HCITR_RTS_PORT, EN))
#define HCITR_CTS_GPIO_AHB_BIT         (DEF_CONCAT3(RCC_AHB2ENR_GPIO, HCITR_CTS_PORT, EN))
#define HCITR_RESET_GPIO_AHB_BIT       (DEF_CONCAT3(RCC_AHB2ENR_GPIO, HCITR_RESET_PORT, EN))
