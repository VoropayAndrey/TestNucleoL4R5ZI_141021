...
static char TELECOM_MSG_INBOX_CONTENTS_MESSAGE_0_DATA_BMESSAGE_DATA[] =
   "BEGIN:BMSG\x0D\x0A"
   "VERSION:1.0\x0D\x0A"
   "STATUS:READ  \x0D\x0A"
...
{                                                                                 \
   ...
   svNo,                                                                          \
   svNo,                                                                          \
   TELECOM_MSG_INBOX_CONTENTS_MESSAGE_0_DATA_BMESSAGE_DATA                        \
}

   /* /root/telecom/msg/inbox - Message 1 Data                          */
   /* * NOTE * This is simply preformatted BMSG Data, this              */
   /*          implementation does not build the BMSG programmatically. */
static char TELECOM_MSG_INBOX_CONTENTS_MESSAGE_1_DATA_BMESSAGE_DATA[] =
   "BEGIN:BMSG\x0D\x0A"
   "VERSION:1.0\x0D\x0A"
   "STATUS:READ  \x0D\x0A"
   "TYPE:EMAIL\x0D\x0A"
...
{                                                                                 \
   ...
   svNo,                                                                          \
   svNo,                                                                          \
   TELECOM_MSG_INBOX_CONTENTS_MESSAGE_1_DATA_BMESSAGE_DATA                        \
}

   /* /root/telecom/msg/inbox - Message 2 Data                          */
   /* * NOTE * This is simply preformatted BMSG Data, this              */
   /*          implementation does not build the BMSG programmatically. */
static char TELECOM_MSG_INBOX_CONTENTS_MESSAGE_2_DATA_BMESSAGE_DATA[]  =
   "BEGIN:BMSG\x0D\x0A"
   "VERSION:1.0\x0D\x0A"
...
{                                                                                 \
   ...
   svNo,                                                                          \
   svNo,                                                                          \
   TELECOM_MSG_INBOX_CONTENTS_MESSAGE_2_DATA_BMESSAGE_DATA                        \
}

   /* /root/telecom/msg/outbox - Message 0 Data                         */
   /* * NOTE * This is simply preformatted BMSG Data, this              */
   /*          implementation does not build the BMSG programmatically. */
static char TELECOM_MSG_OUTBOX_CONTENTS_MESSAGE_0_DATA_BMESSAGE_DATA[] =
   "BEGIN:BMSG\x0D\x0A"
   "VERSION:1.0\x0D\x0A"
   "STATUS:READ  \x0D\x0A"
...
{                                                                                 \
   ...
   svYes,                                                                         \
   svNo,                                                                          \
   TELECOM_MSG_OUTBOX_CONTENTS_MESSAGE_0_DATA_BMESSAGE_DATA                       \
}

   /* /root/telecom/msg/sent - Message 0 Data                           */
   /* * NOTE * This is simply preformatted BMSG Data, this              */
   /*          implementation does not build the BMSG programmatically. */
static char TELECOM_MSG_SENT_CONTENTS_MESSAGE_0_DATA_BMESSAGE_DATA[] =
   "BEGIN:BMSG\x0D\x0A"
   "VERSION:1.0\x0D\x0A"
   "STATUS:UNREAD\x0D\x0A"
   "TYPE:EMAIL\x0D\x0A"
...
{                                                                                 \
   ...
   svNo,                                                                          \
   svNo,                                                                          \
   TELECOM_MSG_SENT_CONTENTS_MESSAGE_0_DATA_BMESSAGE_DATA                         \
}

   /* PTS Message Data                                                  */
   /* * NOTE * This is simply preformatted BMSG Data, this              */
   /*          implementation does not build the BMSG programmatically. */
static char PTS_TELECOM_MSG_CONTENTS_MESSAGE_DATA_BMESSAGE_DATA[] =
   "BEGIN:BMSG\x0D\x0A"
   "VERSION:1.0\x0D\x0A"
   "STATUS:UNREAD\x0D\x0A"
   "TYPE:MMS\x0D\x0A"
...
{                                                                                 \
   ...
   svNo,                                                                          \
   svNo,                                                                          \
   PTS_TELECOM_MSG_CONTENTS_MESSAGE_DATA_BMESSAGE_DATA                            \
}
...
Boolean_t GenerateUniqueMessageHandle(unsigned int BufferLength, char *MessageHandleBuffer)
{
   ...
   {
      BTPS_SprintF(MessageHandleBuffer, "%s%08lX", MESSAGE_HANDLE_PREFIX_STRING, NextMessageHandle++);
