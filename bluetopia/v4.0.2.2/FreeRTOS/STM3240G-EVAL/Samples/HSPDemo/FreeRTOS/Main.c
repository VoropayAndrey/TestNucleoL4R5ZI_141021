...
/* The following represent the possible values of UI_Mode variable in the HSPDemo.c file  */
...
/* External int that reflect the static int UI_Mode from HSPDemo.c    */
extern int  UI_Mode;
static void DisplayPrompt(void);
/* Displays the correct prompt depening on the Server/Client/Choose mode Mode.   */
static void DisplayPrompt(void)
{
...
int main(void)
{
   ...
   if(xTaskCreate(MainThread, (const signed char *)"MainApp", 512, NULL, 3, &Handle) != pdPASS)
   {
