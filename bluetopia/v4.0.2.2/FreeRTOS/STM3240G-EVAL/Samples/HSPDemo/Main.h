...
#define APPLICATION_ERROR_UNABLE_TO_OPEN_STACK     (-1001)
 ...
 /* Bluetooth Protocol Demo Application Major Version Release Numbers.  */
#define DEMO_APPLICATION_MAJOR_VERSION_NUMBER      0

 /* Bluetooth Protocol Demo Application Minor Version Release Numbers.  */
...
#define VERSION_CONSTANT_TO_STRING(_y)             VERSION_NUMBER_TO_STRING(_y)
   ...
   /*  Demo Apllication Version String of the form "a.b"                */      
   /* where:                                                            */
