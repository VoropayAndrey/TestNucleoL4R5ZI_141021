...
int                        UI_Mode;                 /* Variable used to indicate if the*/
   ...
   if(CommandParser(&TempCommand, Command) >= 0)
   {
      ...
      switch(Result)
      {
         ...
         case EXIT_CODE:
            ...
            /* Clear the variable which holds the Handle */
            /* of the active HID Connection */
            HIDID = 0;
   ...
   if(BluetoothStackID)
   {
      ...
      if(!Result)
      {
         ...
         else
         {
            ...
            {
               /* An error occurred while attempting to unregister   */
               /* the server.                                        */
   ...
   if((BluetoothStackID) && (HIDEventData != NULL))
   {
      ...
      switch(HIDEventData->Event_Data_Type)
      {
         case etHID_Open_Indication:
            ...
            {
               /* There is currently an ongong connection, since this   */
